...
```{r Histogram,fig.height=4, cache=TRUE, echo=TRUE,message=F,warning=F}
library(dplyr)
library(ggplot2)
...
```{r Mean and Median, echo=T, cache=T, results='hold'}
...
```{r Avg per Interval, fig.height= 4, cache=TRUE, echo=TRUE,message=F,warning=F,fig.show='hold',results='hold'}
...
```{r Imputing missing values, fig.height= 4, cache=TRUE, echo=TRUE,message=F,warning=F,fig.show='hold',results='hold'}
data2<- activitydata
...
```{r Weekend and Weekdays, cache=TRUE, echo=TRUE,message=F,warning=F,fig.show='hold',results='hold'}
data4 <- data2
